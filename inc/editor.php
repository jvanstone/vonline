...
function vonline_editor_styles() {
	wp_enqueue_style( 'vonline-block-editor-styles', get_theme_file_uri( '/vonline-gutenberg-editor-styles.css' ), '', '1.0', 'all' );

	wp_enqueue_style( 'vonline-fonts', esc_url( vonline_enqueue_google_fonts() ), array(), null );
	...
	wp_add_inline_style( 'vonline-block-editor-styles', $custom );	

}
add_action( 'enqueue_block_editor_assets', 'vonline_editor_styles' );