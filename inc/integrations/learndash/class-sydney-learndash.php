...
if ( !class_exists( 'vonline_Learndash' ) ) :

	/**
	 * vonline_Learndash 
	 */
	Class vonline_Learndash {
		...
		public function setup() {
			...
			//Sidebar
			$course_sidebar = get_theme_mod( 'vonline_lifter_single_course_sidebar', 'sidebar-right' );
		...
		public function body_classes( $classes ) {
			$course_sidebar = get_theme_mod( 'vonline_lifter_single_course_sidebar', 'sidebar-right' );
			$lesson_sidebar = get_theme_mod( 'vonline_lifter_single_lesson_sidebar', 'sidebar-right' );
	 ...
	 * Initialize class
	 */
	vonline_Learndash::get_instance();
