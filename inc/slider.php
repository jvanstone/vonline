...
//Slider template
if ( ! function_exists( 'vonline_slider_template' ) ) :
function vonline_slider_template() {
    ...
    $button     = vonline_slider_button();
    $mobile_slider = get_theme_mod('mobile_slider', 'responsive');

    //Slider text
    if ( !function_exists('pll_register_string') ) {
    	$titles = array(
    		'slider_title_1' => get_theme_mod('slider_title_1', 'Welcome to vonline'),
    ...
    <div id="slideshow" class="header-slider" data-speed="<?php echo esc_attr($speed); ?>" data-mobileslider="<?php echo esc_attr($mobile_slider); ?>">
        ...
        <?php foreach ( $images as $image ) {
        	if ( $image ) {
                ...
                $image_alt = vonline_image_alt( $image );
        		?>
...
function vonline_slider_button() {
...
function vonline_stop_text() {

    if ( !function_exists('pll_register_string') ) {
        $slider_title_1     = get_theme_mod('slider_title_1', 'Welcome to vonline');
        $slider_subtitle_1  = get_theme_mod('slider_subtitle_1','Feel free to look around');
    } else {
        $slider_title_1     = pll__(get_theme_mod('slider_title_1', 'Welcome to vonline'));
    ...
    <div class="slide-inner text-slider-stopped">
        ...
        <?php echo vonline_slider_button(); ?>
    </div>   
    <?php 
}