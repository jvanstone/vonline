 ...
 */
function vonline_get_font_families_options() {
 ...
 */
if ( !function_exists('vonline_enqueue_google_fonts') ) :
	function vonline_enqueue_google_fonts() {

		//Get user choices for font families
		$fonts 				= vonline_get_font_families_options();
 ...
 */
function vonline_migrate_fonts() {
...
add_action( 'after_setup_theme', 'vonline_migrate_fonts' );