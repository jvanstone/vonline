...
( function( $ ) {
	...
	wp.customize( 'body_font', function( value ) {
		value.bind( function( to ) {
			...
			$( '#vonline-preview-google-fonts-body-css' ).attr( 'href', 'https://fonts.googleapis.com/css?family=' + to.replace(/ /g, '+') + '&display=swap' );
	...
	wp.customize( 'headings_font', function( value ) {
		value.bind( function( to ) {
			...
			$( '#vonline-preview-google-fonts-headings-css' ).attr( 'href', 'https://fonts.googleapis.com/css?family=' + to.replace(/ /g, '+') + '&display=swap' );
