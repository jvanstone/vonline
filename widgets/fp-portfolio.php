...
class vonline_Portfolio extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'vonline_portfolio_widget', 'description' => __( 'Display your projects in a grid.', 'vonline') );
       parent::__construct(false, $name = __('vonline FP: Portfolio', 'vonline'), $widget_ops);
		$this->alt_option_name = 'vonline_portfolio_widget';
  }
  ...
  public function widget( $args, $instance ) {
    ...
    $options = array(
     ...
     'include'       => $includes,
     'filter'        => $show_filter,
     'show_all_text' => ! empty( $show_all_text ) ? $show_all_text : __('Show all', 'vonline')
    );
       ...
       if ( has_post_thumbnail() ) {
           ...
           if ( $project_url ) :
               $output .= '<div class="project-item item isotope-item ' . $termsString . '">';
							 ...
							 $output .= get_the_post_thumbnail($post->ID,'vonline-mas-thumb');
							 $output .= '</a>';
							 $output .= '</div>';
           else :
               $output .= '<div class="project-item item isotope-item ' . $termsString . '">';
 ...
 function form($instance) {
    ...
    $show_all_text = isset( $instance['show_all_text'] )  ? esc_html($instance['show_all_text']) : __('Show all', 'vonline');
