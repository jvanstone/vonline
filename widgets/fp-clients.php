...
class vonline_Clients extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'vonline_clients_widget', 'description' => __( 'Display your clients list.', 'vonline') );
        parent::__construct(false, $name = __('vonline FP: Clients', 'vonline'), $widget_ops);
		$this->alt_option_name = 'vonline_clients_widget';
    }
...
?>
				...
				<?php while ( $clients->have_posts() ) : $clients->the_post(); ?>
					...
					<?php if ( has_post_thumbnail() ) : ?>
						<div class="client-item">
							...
							<?php else : ?>
								<?php the_post_thumbnail('vonline-small-thumb'); ?>
							<?php endif; ?>
						</div>
					<?php endif; ?>
				<?php endwhile; ?>
			...
			<?php if ($see_all != '') : ?>
				<a href="<?php echo esc_url($see_all); ?>" class="roll-button more-button">
					...
					<?php else : ?>
						<?php echo __('See all our clients', 'vonline'); ?>
					<?php endif; ?>
				</a>
			<?php endif; ?>	
